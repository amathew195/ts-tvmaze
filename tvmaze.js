...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield axios__WEBPACK_IMPORTED_MODULE_0___default().get(API_URL, {
            params: { q: term },
        });
        return resp.data;
    });
...
function populateShows(shows) {
    ...
    for (let show of shows) {
        ...
        const $show = jquery__WEBPACK_IMPORTED_MODULE_1__(`<div data-show-id="${id}" class="Show col-md-12 col-lg-6 mb-4">
         <div class="media">
           <img
              src="${(image === null || image === void 0 ? void 0 : image.medium) || MISSING_IMG_URL}"
              alt=${name}
              class="w-25 me-3">
...
function searchForShowAndDisplay() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const shows = yield getShowsByTerm(term);
        $episodesArea.hide();
        populateShows(shows);
    });
}
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function* () {
        const { data } = yield axios__WEBPACK_IMPORTED_MODULE_0___default().get(`http://api.tvmaze.com/shows/${id}/episodes`);
        return data;
    });
}
...
function populateEpisodes(episodes) {
    ...
    for (const { name, season, number } of episodes) {
        const $li = jquery__WEBPACK_IMPORTED_MODULE_1__(`<li>${name} (Season: ${season} Number: ${number})</li>`);
...
$showsList.on("click", "button.Show-getEpisodes", function (evt) {
    return __awaiter(this, void 0, void 0, function* () {
        const id = jquery__WEBPACK_IMPORTED_MODULE_1__(evt.target).closest(".Show").data("show-id");
        const episodes = yield getEpisodesOfShow(id);
